package com.automataevox.craftapi.endpoints.v1;

import com.automataevox.craftapi.CraftAPI;
import com.automataevox.craftapi.handlers.LogHandler;
import com.automataevox.craftapi.listeners.ChatListener;
import com.automataevox.craftapi.utils.Helper;
...
import static com.automataevox.craftapi.utils.Helper.formatSize;
...
public final class ServerAPI {
    ...
    public ServerAPI() {
        ...
        Bukkit.getPluginManager().registerEvents(chatListener, CraftAPI.getInstance());
    ...
    public NanoHTTPD.Response execCommand(final Map<String, String> params) {
        ...
        BukkitTask t1 = Bukkit.getScheduler().runTask(CraftAPI.getInstance(), () -> {
    ...
    public NanoHTTPD.Response reload(final Map<String, String> ignoredParams) {
        ...
        }.runTaskLater(CraftAPI.getInstance(), delay);
